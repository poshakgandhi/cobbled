...
class MainAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        def on_request_started(sender, **kwargs):
            ...
            # Ensure database schema is up to date on legacy SQLite databases across all models
                        ...
                        for field in model._meta.concrete_fields:
                            ...
                            if col_name not in existing_cols:
                                ...
                                try:
                                    ...
                                    logger.info(f"Auto-migrated {db_table}: added column {col_name}")
                                except Exception as err:
                                    logger.warning(f"Warning migrating {db_table}.{col_name}: {err}")
